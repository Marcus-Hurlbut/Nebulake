...
public class ControllerServlet extends HttpServlet {
    ...
    private void loginUsers(HttpServletRequest request, HttpServletResponse response)
        ...
        String validation = userDAO.loginUsers(input);
        boolean verifiedEmail = userDAO.getLoginVerification(username);
        

	        if(validation != null && verifiedEmail != false) {
	            ...
	            HttpSession session = request.getSession(true);
	            session.setAttribute("user", input);     
	            session.setAttribute("AUTHOR", validation);
    ...
    private void setNewPassword(HttpServletRequest request, HttpServletResponse response)
    	...
    	//Users email = (Users) session.getAttribute("EMAIL");
    	...
    	if(code.equals(user.getVerification())) {			
	        ...
	        System.out.println(useremail + hashPasswd + saltString);
        	response.sendRedirect("/LoginPage.jsp");
